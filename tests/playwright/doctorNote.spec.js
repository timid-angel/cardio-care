...
test('test', async ({ page }) => {
  ...
  await page.locator('#doctor-notes-modal-button img').click();
  await page.locator('textarea[name="description"]').click();
  await page.locator('textarea[name="description"]').fill('doctors notes');
  await page.locator('#doctor-note-form').getByRole('button', { name: 'Confirm' }).click();
