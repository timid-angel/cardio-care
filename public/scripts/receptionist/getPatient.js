document.addEventListener('DOMContentLoaded', async () => {
    const fetchDoctors = async () => {
        try {
            const response = await fetch('/receptionist/Doctor');
            if (response.ok) {
    ...
    const showModal = async (email) => {
        ...
        async function unlinkPatient(email) {
            try {
                const response = await fetch(`/receptionist/unlink/${email}`, {
                    method: 'DELETE',
                });
        ...
        const linkPatientWithDoctor = async (patientEmail, doctorEmail, linkType) => {
            try {
                const response = await fetch('/receptionist/patients/link', {
                    method: 'POST',
                    headers: {
    ...
    const renderPatients = (patients) => {
        ...
        patients.forEach((patient, index) => {
            ...
            async function deactivatePatient(email) {
                try {
                    const response = await fetch(`/receptionist/deactivate-patient/${email}`, {
                        method: 'PUT',
                    });
            ...
            async function reactivatePatient(email) {
                try {
                    const response = await fetch(`/receptionist/reactivate-patient/${email}`, {
                        method: 'PUT',
                    });
